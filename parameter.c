...
_parameter_namespace_find_w_id_len(parameter_namespace_t* ns, const char* id, size_t id_len)
{
...
parameter_t* _parameter_find_w_id_len(parameter_namespace_t* ns, const char* id, size_t id_len)
{
...
void parameter_string_declare(parameter_t* p, parameter_namespace_t* ns, const char* id, char* buf, uint16_t buf_size)
{

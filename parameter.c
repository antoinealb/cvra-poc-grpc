...
void parameter_port_assert(bool condition) {}
...
_parameter_namespace_find_w_id_len(parameter_namespace_t *ns, const char *id,
                                   size_t id_len) {
...
parameter_t *_parameter_find_w_id_len(parameter_namespace_t *ns, const char *id,
                                      size_t id_len) {
...
void parameter_scalar_declare_with_default(parameter_t *p,
                                           ...
                                           const char *id, float default_val) {
...
void parameter_boolean_declare_with_default(parameter_t *p,
                                            parameter_namespace_t *ns,
                                            const char *id, bool default_val) {
...
void parameter_variable_vector_set(parameter_t *p, const float *v,
                                   uint16_t dim) {
  parameter_port_assert(p->type == _PARAM_TYPE_VAR_VECTOR);
  parameter_port_lock();
...
void parameter_string_declare(parameter_t *p, parameter_namespace_t *ns,
                              const char *id, char *buf, uint16_t buf_size) {
